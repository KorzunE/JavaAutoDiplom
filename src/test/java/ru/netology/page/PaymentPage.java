...
public class PaymentPage {
    ...
    public void validPayCard(DataHelper.CardInfo info) {
    ...
    public void inValidPayCard(DataHelper.CardInfo ignoredInfo) {
    ...
    public void emptyField(DataHelper.CardInfo ignoredInfo) {
        continueButton.click();
        new PaymentPage();
    }
